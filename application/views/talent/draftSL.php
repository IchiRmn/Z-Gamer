	            		...
	            		<div class="bo9 p-l-20 p-r-20 p-t-30 p-b-30 " style="background-color: black;">
					        ...
					        <div class="row">
					            <div class="col text-center m-t-15">
				                    <a href="<?= base_url('Talent/SoloRegist/'.$tour->id_tour)?>" class="boton bo-rad-23  m-text20 trans-0-4 text-white" style="padding: 11px; padding-left: 80px; padding-right: 80px;">
				                        Join!
				                    </a>
					            </div>
					        </div>
